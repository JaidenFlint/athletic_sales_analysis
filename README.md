 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "daily_total_sales = invoice_total_sales_pivot.resample('D').sum()\n",
    "\n",
    "# Sort the resampled pivot table in descending order on \"Total Sales\".\n",
    "sorted_daily_total_sales = daily_total_sales.sort_values(by='Total Sales', ascending=False).head(10)"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "weekly_total_sales = invoice_total_sales_pivot.resample('W').sum()\n",
    "\n",
    "# Sort the resampled pivot table in descending order on \"Total Sales\".\n",
    "sorted_weekly_total_sales = weekly_total_sales.sort_values(by='Total Sales', ascending=False).head(10)"
   ]
  },
  {
   "cell_type": "code",
